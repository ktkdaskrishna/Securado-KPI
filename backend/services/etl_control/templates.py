        ...
        "default_mappings": {
            "crm.lead": {
                ...
                "fields": [
                    ...
                    {"source_field": "stage_id", "target_field": "stage_id_raw", "transform": "extract_name"},
                    {"source_field": "x_studio_opportunity_stages_1", "target_field": "stage", "transform": "extract_name"},
    ...
    "hubspot": {
        ...
        "default_mappings": {
            "deals": {
                "target_entity": "opportunity",
                "fields": [
                    {"source_field": "hs_object_id", "target_field": "canonical_id", "transform": "direct"},
