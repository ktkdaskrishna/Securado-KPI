...
curl -H "Authorization: Bearer <ADMIN_TOKEN>" \\
  https://filter-connect.preview.emergentagent.com/api/admin/users?status=pending
```

**Step 2: Approve User**
```bash
curl -X POST -H "Authorization: Bearer <ADMIN_TOKEN>" \\
  https://filter-connect.preview.emergentagent.com/api/admin/users/{user_id}/approve
```
...
curl -X PATCH -H "Authorization: Bearer <ADMIN_TOKEN>" \\
  ...
  -d '{"role": "sales_rep"}' \\
  https://filter-connect.preview.emergentagent.com/api/admin/users/{user_id}/assign-role
```
...
curl -X PUT -H "Authorization: Bearer <ADMIN_TOKEN>" \\
  ...
  https://filter-connect.preview.emergentagent.com/api/admin/users/{user_id}
```
...
curl -X POST -H "Authorization: Bearer <ADMIN_TOKEN>" \\
  ...
  https://filter-connect.preview.emergentagent.com/api/admin/users/bulk-assign-role
```
...
curl -X POST -H "Authorization: Bearer <ADMIN_TOKEN>" \\
  ...
  https://filter-connect.preview.emergentagent.com/api/admin/users/bulk-assign-department
```
...
curl -H "Authorization: Bearer <TOKEN>" \\
  https://filter-connect.preview.emergentagent.com/api/admin/roles
```
...
curl -X POST -H "Authorization: Bearer <ADMIN_TOKEN>" \\
  ...
  https://filter-connect.preview.emergentagent.com/api/admin/departments
```
...
curl -X POST -H "Content-Type: application/json" \\
  ...
  https://filter-connect.preview.emergentagent.com/api/auth/register

# 2. Admin logs in
TOKEN=$(curl -s -X POST -H "Content-Type: application/json" \\
  -d '{"email":"admin@platform2.com","password":"admin123"}' \\
  https://filter-connect.preview.emergentagent.com/api/auth/login | jq -r '.access_token')
...
curl -X PATCH -H "Authorization: Bearer $TOKEN" \\
  -H "Content-Type: application/json" \\
  https://filter-connect.preview.emergentagent.com/api/admin/users/{USER_ID}/assign-role?role=sales_rep

# 6. User can now login
curl -X POST -H "Content-Type: application/json" \\
  -d '{"email":"jane@company.com","password":"Secure123!"}' \\
  https://filter-connect.preview.emergentagent.com/api/auth/login
```
...
4. **Test Connection:**
   ```bash
   curl https://filter-connect.preview.emergentagent.com/api/data-lake/health
   ```
...
curl -X PUT -H "Authorization: Bearer <ADMIN_TOKEN>" \\
  ...
  https://filter-connect.preview.emergentagent.com/api/admin/users/{admin_user_id}
```
...
- **API Documentation UI:** https://filter-connect.preview.emergentagent.com
