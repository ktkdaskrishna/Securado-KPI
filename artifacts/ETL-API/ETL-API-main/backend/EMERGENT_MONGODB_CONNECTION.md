...
### Environment Details
- **Preview URL:** https://fixmycrm.preview.emergentagent.com
- **Backend API:** https://fixmycrm.preview.emergentagent.com/api
...
```
Base URL: https://fixmycrm.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://fixmycrm.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://fixmycrm.preview.emergentagent.com
