...
### Environment Details
- **Preview URL:** https://odoo-model-map.preview.emergentagent.com
- **Backend API:** https://odoo-model-map.preview.emergentagent.com/api
...
```
Base URL: https://odoo-model-map.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://odoo-model-map.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://odoo-model-map.preview.emergentagent.com
