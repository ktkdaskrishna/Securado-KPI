...
### Environment Details
- **Preview URL:** https://goal-tracker-369.preview.emergentagent.com
- **Backend API:** https://goal-tracker-369.preview.emergentagent.com/api
...
```
Base URL: https://goal-tracker-369.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://goal-tracker-369.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://goal-tracker-369.preview.emergentagent.com
