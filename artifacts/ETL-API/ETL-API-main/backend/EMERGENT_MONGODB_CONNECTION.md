...
### Environment Details
- **Preview URL:** https://filter-connect.preview.emergentagent.com
- **Backend API:** https://filter-connect.preview.emergentagent.com/api
...
```
Base URL: https://filter-connect.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://filter-connect.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://filter-connect.preview.emergentagent.com
