...
### Environment Details
- **Preview URL:** https://ai-assistant-test-2.preview.emergentagent.com
- **Backend API:** https://ai-assistant-test-2.preview.emergentagent.com/api
...
```
Base URL: https://ai-assistant-test-2.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://ai-assistant-test-2.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://ai-assistant-test-2.preview.emergentagent.com
