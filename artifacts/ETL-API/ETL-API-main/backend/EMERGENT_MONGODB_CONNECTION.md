...
### Environment Details
- **Preview URL:** https://layout-manager-1.preview.emergentagent.com
- **Backend API:** https://layout-manager-1.preview.emergentagent.com/api
...
```
Base URL: https://layout-manager-1.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://layout-manager-1.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://layout-manager-1.preview.emergentagent.com
