...
### Environment Details
- **Preview URL:** https://crm-fixer-3.preview.emergentagent.com
- **Backend API:** https://crm-fixer-3.preview.emergentagent.com/api
...
```
Base URL: https://crm-fixer-3.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://crm-fixer-3.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://crm-fixer-3.preview.emergentagent.com
