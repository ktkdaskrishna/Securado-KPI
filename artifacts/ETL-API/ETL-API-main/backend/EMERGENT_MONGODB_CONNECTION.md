...
### Environment Details
- **Preview URL:** https://dataflow-designer.preview.emergentagent.com
- **Backend API:** https://dataflow-designer.preview.emergentagent.com/api
...
```
Base URL: https://dataflow-designer.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://dataflow-designer.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://dataflow-designer.preview.emergentagent.com
