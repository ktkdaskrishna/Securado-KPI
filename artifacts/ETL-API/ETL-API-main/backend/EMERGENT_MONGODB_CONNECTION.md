...
### Environment Details
- **Preview URL:** https://b227a6d1-c68c-4703-8903-bad073844ec4.preview.emergentagent.com
- **Backend API:** https://crm-api-gateway.preview.emergentagent.com/api
...
```
Base URL: https://crm-api-gateway.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://crm-api-gateway.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://crm-api-gateway.preview.emergentagent.com
