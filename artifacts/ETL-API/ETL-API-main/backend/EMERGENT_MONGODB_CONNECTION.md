...
### Environment Details
- **Preview URL:** https://eventmesh-3.preview.emergentagent.com
- **Backend API:** https://eventmesh-3.preview.emergentagent.com/api
...
```
Base URL: https://eventmesh-3.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://eventmesh-3.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://eventmesh-3.preview.emergentagent.com
