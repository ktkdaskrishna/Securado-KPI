...
### Environment Details
- **Preview URL:** https://perf-dashboard-fix-1.preview.emergentagent.com
- **Backend API:** https://perf-dashboard-fix-1.preview.emergentagent.com/api
...
```
Base URL: https://perf-dashboard-fix-1.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://perf-dashboard-fix-1.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://perf-dashboard-fix-1.preview.emergentagent.com
