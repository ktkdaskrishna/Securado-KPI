...
### Environment Details
- **Preview URL:** https://datamapper-10.preview.emergentagent.com
- **Backend API:** https://datamapper-10.preview.emergentagent.com/api
...
```
Base URL: https://datamapper-10.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://datamapper-10.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://datamapper-10.preview.emergentagent.com
