...
### Environment Details
- **Preview URL:** https://odoo-sync-builder.preview.emergentagent.com
- **Backend API:** https://odoo-sync-builder.preview.emergentagent.com/api
...
```
Base URL: https://odoo-sync-builder.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://odoo-sync-builder.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://odoo-sync-builder.preview.emergentagent.com
