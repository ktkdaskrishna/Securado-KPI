...
### Environment Details
- **Preview URL:** https://datahub-crm-1.preview.emergentagent.com
- **Backend API:** https://datahub-crm-1.preview.emergentagent.com/api
...
```
Base URL: https://datahub-crm-1.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://datahub-crm-1.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://datahub-crm-1.preview.emergentagent.com
