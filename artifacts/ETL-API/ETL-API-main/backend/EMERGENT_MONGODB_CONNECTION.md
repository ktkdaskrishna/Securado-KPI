...
### Environment Details
- **Preview URL:** https://unifystream.preview.emergentagent.com
- **Backend API:** https://unifystream.preview.emergentagent.com/api
...
```
Base URL: https://unifystream.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://unifystream.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://unifystream.preview.emergentagent.com
