...
### Environment Details
- **Preview URL:** https://crmdatahub.preview.emergentagent.com
- **Backend API:** https://crmdatahub.preview.emergentagent.com/api
...
```
Base URL: https://crmdatahub.preview.emergentagent.com/api
...
```bash
# Login to get token
TOKEN=$(curl -s -X POST https://crmdatahub.preview.emergentagent.com/api/auth/login \
...
- **Platform 2 API Docs:** https://crmdatahub.preview.emergentagent.com
