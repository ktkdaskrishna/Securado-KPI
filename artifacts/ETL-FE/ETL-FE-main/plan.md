...
- Backend is Platform 2 (already deployed at https://odoo-model-map.preview.emergentagent.com); invoices route enabled only if endpoint exists.
...
### Live URLs
- Frontend: https://odoo-model-map.preview.emergentagent.com
- Platform 2 Backend: https://odoo-model-map.preview.emergentagent.com/api
