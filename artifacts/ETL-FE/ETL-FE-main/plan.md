...
- Backend is Platform 2 (already deployed at https://perf-dashboard-fix-1.preview.emergentagent.com); invoices route enabled only if endpoint exists.
...
### Live URLs
- Frontend: https://perf-dashboard-fix-1.preview.emergentagent.com
- Platform 2 Backend: https://perf-dashboard-fix-1.preview.emergentagent.com/api
