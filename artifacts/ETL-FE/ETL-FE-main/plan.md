...
- Backend is Platform 2 (already deployed at https://odoo-sync-builder.preview.emergentagent.com); invoices route enabled only if endpoint exists.
...
### Live URLs
- Frontend: https://odoo-sync-builder.preview.emergentagent.com
- Platform 2 Backend: https://odoo-sync-builder.preview.emergentagent.com/api
