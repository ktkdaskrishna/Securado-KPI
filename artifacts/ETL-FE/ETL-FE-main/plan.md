...
- Backend is Platform 2 (already deployed at https://crm-api-gateway.preview.emergentagent.com); invoices route enabled only if endpoint exists.
...
### Live URLs
- Frontend: https://salescommand-ui.preview.emergentagent.com
- Platform 2 Backend: https://crm-api-gateway.preview.emergentagent.com/api
