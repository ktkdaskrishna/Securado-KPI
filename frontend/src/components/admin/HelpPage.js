              ...
              <CardContent className="space-y-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2 ml-9">
                    ...
                    <li className="flex items-start gap-2 text-sm text-gray-700">
                      <CheckCircle2 className="h-4 w-4 text-green-500 mt-0.5 shrink-0" />
                      Your Securado CRM app URL (e.g., <code className="px-1.5 py-0.5 bg-gray-100 rounded text-xs font-mono">https://your-app.preview.emergentagent.com</code>)
                    </li>
                  </ul>
                </div>
                        ...
                        <div>
                          ...
                          <div className="mt-2 bg-gray-50 rounded-lg p-3 border border-gray-200 space-y-2">
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <code className="px-2 py-0.5 bg-white rounded border text-xs font-mono break-all">https://your-app.preview.emergentagent.com/login</code>
                            </div>
                          </div>
                        </div>
                      </li>
                    ...
                    <div className="space-y-4 mt-3">
                      <div className="border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="flex items-center gap-2 bg-gray-50 rounded-lg p-2.5 border">
                          <code className="text-xs font-mono text-gray-800 flex-1 break-all">https://your-app.preview.emergentagent.com/login</code>
                      ...
                      <div className="border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="flex items-center gap-2 bg-gray-50 rounded-lg p-2.5 border">
                          <code className="text-xs font-mono text-gray-800 flex-1 break-all">https://your-app.preview.emergentagent.com/api/auth/microsoft/callback</code>
