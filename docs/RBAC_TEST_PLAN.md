...
**Application URL**: https://odoo-sync-portal.preview.emergentagent.com
...
```
STEP 1: Login
- Navigate to: https://odoo-sync-portal.preview.emergentagent.com
...
curl -X GET https://odoo-sync-portal.preview.emergentagent.com/api/odoo-rbac/current-user-rbac \
