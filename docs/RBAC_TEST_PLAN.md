...
**Application URL**: https://sso-fix-checker.preview.emergentagent.com
...
curl -X GET https://sso-fix-checker.preview.emergentagent.com/api/odoo-rbac/current-user-rbac \
