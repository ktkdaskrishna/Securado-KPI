...
**Application URL**: https://permission-audit-2.preview.emergentagent.com
...
```
STEP 1: Login
- Navigate to: https://permission-audit-2.preview.emergentagent.com
...
curl -X GET https://permission-audit-2.preview.emergentagent.com/api/odoo-rbac/current-user-rbac \
